...
$destination = 'saestor://'.$DOMAIN.'/'.$destination_folder.$timec."_".$named;
$destination_title = 'saestor://'.$DOMAIN.'/'.$destination_folder.$timec."_".$names;
...
<?php 
$s = new SaeStorage(); 
echo $s->getUrl( $DOMAIN).$destination_folder.$timec."_".$names; ?>
</textarea>
